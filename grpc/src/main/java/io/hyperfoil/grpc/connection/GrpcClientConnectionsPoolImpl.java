...
public class GrpcClientConnectionsPoolImpl implements GrpcClientConnectionsPool {
    ...
    public GrpcClientConnectionsPoolImpl(String defaultAuthority, Map<String, Grpc> grpcByAuthority, Map<String, Integer> connectionsByAuthority, EventLoop executor) {
        ...
        this.vertx = new VertxBuilder(new VertxOptions()
                ...
                .setWorkerPoolSize(1))
                .transport(transportFor(executor))
    ...
    private static Transport transportFor(EventLoop eventLoop) {
        return new Transport() {
            @Override
            public EventLoopGroup eventLoopGroup(final int type, final int nThreads, final ThreadFactory threadFactory, final int ioRatio) {
