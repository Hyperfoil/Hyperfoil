...
public class ProtoConfig implements Serializable {
    ...
    public Descriptors.FileDescriptor toProtoFileDescriptor() {
        ...
        var importProtoDescs = Stream.of(importProtos).map(proto -> ProtobufSchemaContent.of(proto.fileName, proto.schemaDefinition))
    ...
    public static class Builder implements BuilderBase<Builder> {
        ...
        public ProtoConfig build(BenchmarkData data) {
            ...
            try {
                return new ProtoConfig(GrpcProtoSchema.of(data, mainProto), GrpcProtoSchema.of(data, importPaths.toArray(new String[0])));
            } catch (Throwable t) {
