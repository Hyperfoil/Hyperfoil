...
import io.sailrocket.cli.commands.ReadYaml;
import io.sailrocket.cli.commands.Wrk;
import io.sailrocket.cli.context.SailRocketCliContext;
import io.sailrocket.cli.context.SailRocketCommandInvocation;
import io.sailrocket.cli.context.SailRocketCommandInvocationProvider;
...
public class SailRocketCli {
   ...
   public static void main(String[] args) throws CommandLineParserException, IOException {
       ...
       SailRocketCliContext context = new SailRocketCliContext();
       ...
       Settings settings = builder
              ...
              .commandInvocationProvider(new SailRocketCommandInvocationProvider(context))
              .build();

       ReadlineConsole console = new ReadlineConsole(settings);
       console.setPrompt(new Prompt(new TerminalString("[sailrocket@localhost]$ ",
    ...
    public static class ExitCommand implements Command<SailRocketCommandInvocation> {
