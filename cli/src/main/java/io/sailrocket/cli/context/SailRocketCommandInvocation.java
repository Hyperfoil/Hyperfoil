 ...
 */
public class SailRocketCommandInvocation implements CommandInvocation {

    private final CommandInvocation commandInvocation;
    private final SailRocketCliContext context;

    SailRocketCommandInvocation(SailRocketCliContext context, CommandInvocation commandInvocation) {
        this.context = context;
        this.commandInvocation = commandInvocation;
    }

    public SailRocketCliContext context() {
        return context;
    }
