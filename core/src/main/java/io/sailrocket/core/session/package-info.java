 ...
 * <ul>
 * <li>{@link io.sailrocket.core.session.SequenceImpl Sequence templates} - instructions 'what to do'
 ...
 * the {@link io.sailrocket.core.session.SessionImpl} is {@link io.sailrocket.core.session.SessionImpl#reset()}
 ...
 * {@link io.sailrocket.core.session.SessionImpl#currentSequence(SequenceInstance)}
 * with <code>null</code> argument - {@link io.sailrocket.core.steps.BreakSequenceStep} is an example of that.
 * <p>
