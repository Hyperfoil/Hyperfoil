 ...
 */
public class VertxHttpClient2 implements HttpClient {
  ...
  public VertxHttpClient2(VertxHttpClientBuilder builder) {
  ...
  public HttpRequest request(HttpMethod method, String path) {
    if (inflight.get() < maxInflight) {
      ...
      return new VertxHttpRequest2(method, path, doneHandler, current.get());
    }
    return null;
  }
